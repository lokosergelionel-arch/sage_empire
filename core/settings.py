...
ALLOWED_HOSTS = [
    'sage-empire.com',
    'www.sage-empire.com',
    'sage-empire.onrender.com',
    'localhost',
    '127.0.0.1'
]

CSRF_TRUSTED_ORIGINS = [
    'https://sage-empire.com',
    'https://www.sage-empire.com',
    'https://sage-empire.onrender.com'
]

# Sécurité HTTPS (important en production)
